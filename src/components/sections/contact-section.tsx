...
const ContactSection = () => {
  ...
  const onSubmit: SubmitHandler<ContactFormInputs> = async (data) => {
    const googleAppsScriptUrl = "https://script.google.com/macros/s/AKfycbyn9NzaEg7otOJxDKD_kDKdR6HeZdg9RSD9irvQJW8-Uc7ENiF5iZENwoIY5OySpGRfeA/exec";
  
    const queryString = new URLSearchParams(data).toString();
    const fullUrl = `${googleAppsScriptUrl}?${queryString}`;
